...
/**
 * An interface containing all of the properties expected of the props that are passed into the Wipe component.
 */
interface WipeProps {
...
/**
 * Function that returns a Wipe component,
 * which displays information necessary for the user to wipe their information.
 * @param props all of the information needed for the user to wipe their information.
 * @returns a Wipe component
 */
export function Wipe(props: WipeProps) {
  /**
   * Function that handles wiping the data for a user by making a request to our server.
   */
