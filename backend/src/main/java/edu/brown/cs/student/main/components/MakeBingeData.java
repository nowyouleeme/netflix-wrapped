...
public class MakeBingeData {
  ...
  public JSONBingeData getBingeData(
      String[][] userHistory,
  ...
  public List<Map.Entry<String, Integer>> getShowsInDate(
      String date, ArrayList<Map<String, ArrayList<ArrayList<String>>>> userHistoryMapList) {
  ...
  public ArrayList<String> getMoviesInDate(
      String date, ArrayList<Map<String, ArrayList<ArrayList<String>>>> userHistoryMapList) {
