...
public class IntegrationTest {
   ...
   * @throws IOException when the connection fails or cannot be made
   */
  private static HttpURLConnection tryPostRequest(String apiCall, String requestBody0)
      throws IOException {
    ...
    JsonAdapter<Map<String, Object>> adapter =
        moshi.adapter(
            Types.newParameterizedType(
                Map.class, String.class, Object.class, Data.WrappedData.class));
  ...
  public WrappedResp clientConnectToWrappedResp(HttpURLConnection clientConnection)
      throws IOException {
    Moshi moshi = new Moshi.Builder().build();
  ...
  public void testWipeSuccess() throws IOException {
    ...
    assertNull(serverInfo.getUserData());
    query =
        "{{{\"usercsv\":[[\"Title\"],[\"Crash%20Landing%20on%20You:%20Episode16\",\"3/26/23\"]]}}}";
