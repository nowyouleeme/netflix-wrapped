...
public class SaveDataHandlerTest {
   ...
   */
  private static HttpURLConnection tryRequest(String apiCall, String requestBody0)
      throws IOException {
  ...
  public void testBadJSON() throws IOException {
    ...
    String query =
        "{{{\"bahaha\":[[\"Title\",\"Date\"],[\"Crash%20Landing%20on%20You:%20Episode16\",\"3/26/23\"]]}}}";
    ...
    query =
        "{{{\"userCSV\":[[\"Title\",\"Date\"],[\"Crash%20Landing%20on%20You:%20Episode16\",\"3/26/23\"]]}}}";
    clientConnection = tryRequest("saveData", query);
    assertEquals(200, clientConnection.getResponseCode());
  ...
  public void testBadRequest() throws IOException {
    ...
    // test for 1 column
    query =
        "{{{\"usercsv\":[[\"Title\"],[\"Crash%20Landing%20on%20You:%20Episode16\"],"
    ...
    query =
        "{{{\"usercsv\":[[\"Title\",\"Time\"],[\"Crash%20Landing%20on%20You:%20Episode16\",\"3/26/23\"],"
    ...
    // test for not title date
    query =
        "{{{\"usercsv\":[[\"Media\",\"Time\"],[\"Crash%20Landing%20on%20You:%20Episode16\",\"3/26/23\"],"
            + "[\"Crash%20Landing%20on%20You:%20Episode15\",\"3/26/23\"],"
            + "[\"Crash%20Landing%20on%20You:%20Episode14\",\"3/26/23\"]]}}}";
    clientConnection = tryRequest("saveData", query);
    assertEquals(200, clientConnection.getResponseCode());
